...
export const configuration = {
  header : {
    ...
    '          personal and commercial projects, enjoy!',
     headingButton: 'Do some action!',
     buttonLink: '#'
  },
  intro : {
    tagLine: "SUCCESS",
    sectionTitle: "How We Help You To Sell Your Product",
  ...
  services : {
    tagLine: "BELIEVING",
    sectionTitle: "Focusing On What Matters Most",
    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do\n" +
    "          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam!"
  },
  testimonials : {
  ...
  clients : {
    tagLine: "TRUST",
    sectionTitle: "Companies who use our services",
    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do\n" +
    "          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam!",
    companies: [
  ...
  pricing : {
    tagLine: "YOUR CHOICE",
    sectionTitle: "We have the right package for you",
    plans: [
      ...
      {title: 'BUSINESS', subtitle: 'For the whole team', description: 'Lorem ipsum dsolor sit amet, consectetur adipiscing elit', price: '49', currency: '₹',
  ...
  footer: {
    ...
    developer: 'Ratko Korlevski',
    developerlink: 'https://ratkorle.github.io/',
  },
  socialSites: [
    {title: 'Facebook', target: '_blank', username: 'ratkorle', icon: 'facebook'},
    {title: 'Google+', target: '_blank', username: '+ratkorle', icon: 'google-plus'},
    {title: 'Twitter', target: '_blank', username: 'ratkorle', icon: 'twitter'},
    {title: 'Instagram', target: '_blank', username: 'ratkorle', icon: 'instagram'},
    {title: 'Behance', target: '_blank', username: 'ratkorle', icon: 'behance'},
  ],
  blog: {
    tagline: 'MY BLOG',
